...
#### Example Dataset
Th data used in this ReadMe came from the [Adult Data Set](https://archive.ics.uci.edu/ml/datasets/adult) in the UCI Machince Learning Repository, accessed on April 2019.
